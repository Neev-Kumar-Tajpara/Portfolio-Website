...
const PROJECTS = [
    {
        ...
        desc: "Adaptive liquidity provision algorithms designed for decentralized exchanges. Features inventory management and spread adjustment based on volatility.",
        stars: 892,
        forks: 140,
        lang: "Python",
        color: "bg-yellow-400"
    ...
    {
        name: "ledger-core-cpp",
        desc: "Double-entry accounting system implementation optimized for high-throughput crypto asset tracking. Zero-dependency architecture.",
        stars: 430,
        forks: 56,
        lang: "C++",
        color: "bg-blue-500"
    ...
    {
        name: "option-pricing-rs",
        desc: "Extremely fast options pricing library using Monte Carlo simulations. Leverages Rust's memory safety and concurrency features.",
        stars: "1.5k",
        forks: 203,
        lang: "Rust",
        color: "bg-orange-600"
    ...
    {
        name: "monte-carlo-cuda",
        desc: "GPU-accelerated risk engine for calculating Value at Risk (VaR) on large portfolios. Requires NVIDIA CUDA toolkit.",
        stars: 312,
        forks: 45,
        lang: "CUDA C++",
        color: "bg-green-500"
    ...
    {
        name: "tick-data-normalizer",
        desc: "Pipeline for ingesting raw exchange websocket feeds and normalizing them into standard OHLCV formats for backtesting.",
        stars: 189,
        forks: 22,
        lang: "Go",
        color: "bg-blue-400"
    },
    {
        ...
        desc: "Static analysis tool for detecting common vulnerabilities in Solidity smart contracts. Integrated with CI/CD pipelines.",
        stars: 674,
        forks: 98,
        lang: "TypeScript",
        color: "bg-purple-500"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2">
                        ...
                        <div className="p-8 flex flex-col justify-between bg-background/50">
                            ...
                            <div className="flex items-center gap-6 pt-6 border-t border-grid-line">
                                ...
                                <div className="flex items-center gap-1 text-muted-foreground hover:text-white transition-colors cursor-pointer ml-auto">
                                    <span className="font-mono text-xs uppercase mr-1">View Repo</span>
            ...
            <section className="relative z-10 px-6 md:px-12 max-w-[1920px] mx-auto pb-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {PROJECTS.map((project, idx) => (
                        <Link href="#" key={idx} className="group relative bg-[#050505] border border-grid-line p-6 flex flex-col h-full rounded hover:border-primary transition-colors duration-300 overflow-hidden">
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-grid-line/50 mt-auto">
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <span className="text-xs text-muted-foreground font-mono">{project.lang}</span>
                                </div>
